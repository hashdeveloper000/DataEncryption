...
user_id: firstRow ? firstRow.user_id : null,
  ...
  const handleDecrypt = async () => {
    ...
    try {
      const response = await axios.post(`https://standardencyptionprotocolstest.onrender.com/decrypt?key=${key}`, formData);
    ...
    <div>
      ...
      {encryptedFile && (
        <div>
          ...
          <p>Key: {encryptedFile.key}</p>
           <p>Download: <a href={`https://standardencyptionprotocolstest.onrender.com/download/${encryptedFile.encrypted_filename}`} download>Download Encrypted File</a></p>
      ...
      {decryptedFile && (
        <div>
          ...
          <p>Download: <a href={`https://standardencyptionprotocolstest.onrender.com/download/${decryptedFile.decrypted_filename}`} download>Download Decrypted File</a></p>
        </div>
      )}
 <br />
      <div>
